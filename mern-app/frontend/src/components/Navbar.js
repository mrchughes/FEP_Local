...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <header className="govuk-header service-header" role="banner" data-module="govuk-header">
                <div className="govuk-header__container govuk-width-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
                        <div className="govuk-header__logo">
                            <a href="https://www.gov.uk" className="govuk-header__link govuk-header__link--homepage" style={{ color: '#fff' }}>
                                <span className="govuk-header__logotype">
                                    ...
                                    <span className="govuk-header__logotype-text" style={{ color: '#fff' }}>GOV.UK</span>
                                </span>
                            </a>
                        </div>
                        <Link to="/" className="govuk-header__service-name" style={{ fontSize: '2rem', fontWeight: 700, marginLeft: 24, color: '#fff', textDecoration: 'none', lineHeight: '1.1' }}>
